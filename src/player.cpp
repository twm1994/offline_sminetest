...
//		scene::ISceneNode(NULL, NULL, 0), speed(0, 0, 0), touching_ground(
//				false), peer_id(PEER_ID_NEW), timeout_counter(0.0), m_is_local(
//				is_local), m_position(0, 0, 0) {
//}
Player::Player(bool is_local) :
		scene::ISceneNode(NULL, NULL, 0), speed(0, 0, 0), touching_ground(
				false), m_is_local(is_local), m_position(0, 0, 0) {
}
Player::Player(bool is_local, scene::ISceneNode* parent,
